...
public class TodoController {
  ...
  @Operation(
      ...
      description = "Fetch all todos from signed in user")
  ...
  @Operation(summary = "Create todo for user", description = "Create todo for the signed user")
  ...
  @Operation(summary = "Update todo for user", description = "Update todo for the signed user")
  @ResponseStatus(HttpStatus.OK)
  @PutMapping("/{id}")
  public TodoResponse toggleTodoCompletion(@PathVariable @Max(1) long id) {
    return todoService.toggleTodoCompletion(id);
  }

  @Operation(summary = "Delete todo for user", description = "Delete todo for the signed user")
